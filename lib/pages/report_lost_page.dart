    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (user != null) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Lost item reported successfully!')));
          Navigator.pop(context);
        }
      } catch (e) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Failed to report lost item: $e')));
      } finally {
        setState(() {
          isLoading = false;
        });
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: isLoading ? null : _reportLostItem,
                      child: isLoading ? CircularProgressIndicator() : Text('Report Lost Item'),
                    ),
                  ),
                ],
              ),
